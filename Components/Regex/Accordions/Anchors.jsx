      ...
      <ul className="ullist">
        <li className="b0Wk4 tu7rF" role="button" tabindex="0">
          <div className="divegrid">
            <div className="Lta24">Start of match
</div>
...
\G
        ...
        <li className="b0Wk4 tu7rF" role="button" tabindex="0">
          <div className="divegrid">
            <div className="Lta24">Start of string
</div>
...
^
        ...
        <li className="b0Wk4 tu7rF" role="button" tabindex="0">
          <div className="divegrid">
            <div className="Lta24">End of string
</div>
            <div className="IVPLo i8N8D" onClick={ e => setClickToken("$")}>
$
</div>
...
\Z
        ...
        <li className="b0Wk4 tu7rF" role="button" tabindex="0">
          <div className="divegrid">
            <div className="Lta24">Absolute end of string
</div>
            <div className="IVPLo i8N8D" onClick={ e => setClickToken("\\z")}>
\z
</div>
        ...
        <li className="b0Wk4 tu7rF" role="button" tabindex="0">
          <div className="divegrid">
            <div className="Lta24">A word boundary
</div>
...
\b
        ...
        <li className="b0Wk4 tu7rF" role="button" tabindex="0">
          <div className="divegrid">
            <div className="Lta24">Non-word boundary
</div>
            <div className="IVPLo i8N8D" onClick={ e => setClickToken("\\B")}>
\B
</div>
